        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>My experience building websites is in both React <DiReact /> and AngularJS <DiAngularSimple />, accompanied by HTML and CSS.</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>Coming from a CS background, I have good grasp over fundamental concepts of DSA</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
